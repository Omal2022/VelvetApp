...
const items = [
    ...
    },
    {
        ...
        description: "Wisteria flowers bring a sense of enchantment and grace, cascading beautifully to create a dreamy, romantic atmosphere at any event. Their soft hues and flowing form add depth and elegance to floral designs, whether used for ceilings, arches, or centerpieces.",
    ...
    return (
        <>
            <motion.div
                ...
                id="supplyPage"
            >
                {/* <Image src="/Union.svg" alt="User Avatars" width={130} height={130} /> */}
                {/* Left Info Section */}
                <div className="flex-1 flex flex-col justify-center px-8 py-12 lg:py-0 bg-white">
                    <motion.h1
                        className="font-medium text-[24px] sm:text-[350px] md:text-[40px] lg:text-[40px] xl:text-[48px] text-[#004953] mb-4"
                        variants={fadeInUp}
                    ...
                    <motion.p
                        className="custom-text text-gray-500 mb-8 max-w-md"
                        variants={fadeInUp}
                    ...
                    {/* Testimonial Card */}
                    <motion.div
                        className="bg-[#f5f6f7] rounded-2xl p-6 mt-8 lg:max-w-[900px] shadow flex flex-col gap-2"
                        variants={fadeInUp}
                    ...
                    >
                        ...
                        <p className="text-gray-500 text-sm mb-2">
                            “As an event planner, I’m constantly seeking vendors who understand the importance of quality and timeliness. Honestly, VelvetCore and her team exceeded my expectations. They delivered premium materials swiftly, without compromising on standard or detail. Every order arrived exactly as envisioned. VelvetCore was the core of a memorable event.”
                        </p>
                ...
                <div className="flex-1 flex flex-col items-center justify-center px-4 py-10 bg-white relative">
                    ...
                    >
                        <button
                            onClick={prevSlide}
                            className="cursor-pointer absolute left-0  top-1/2 -translate-y-1/2 md:top-[65%] md:-translate-y-0 lg:top-[350px] lg:-translate-y-0 p-2 w-12 h-12 rounded-full flex shadow justify-center items-center text-3xl text-[#004953] bg-gray-100 hover:bg-[#c5b358] ml-10 z-20"
                            aria-label="Previous"
                        >
                        ...
                        <button
                            onClick={nextSlide}
                            className="cursor-pointer absolute right-0 top-1/2 -translate-y-1/2 md:top-[65%] md:-translate-y-0 lg:top-[350px] lg:-translate-y-0 bg-white/80 p-2 w-12 h-12 rounded-full flex justify-center items-center shadow text-3xl text-[#004953] hover:bg-[#c5b358] mr-10 z-20"
                            aria-label="Next"
                        >
